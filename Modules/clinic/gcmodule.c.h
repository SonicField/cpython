...
PyDoc_STRVAR(gc_set_cleanup_workers__doc__,
...
#define GC_SET_CLEANUP_WORKERS_METHODDEF    \
    {"set_cleanup_workers", _PyCFunction_CAST(gc_set_cleanup_workers), METH_FASTCALL|METH_KEYWORDS, gc_set_cleanup_workers__doc__},

static PyObject *
gc_set_cleanup_workers_impl(PyObject *module, int num_workers);

static PyObject *
gc_set_cleanup_workers(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    #if defined(Py_BUILD_CORE) && !defined(Py_BUILD_CORE_MODULE)
    ...
    return_value = gc_set_cleanup_workers_impl(module, num_workers);

exit:
    return return_value;
}

PyDoc_STRVAR(gc_get_cleanup_workers__doc__,
...
#define GC_GET_CLEANUP_WORKERS_METHODDEF    \
    {"get_cleanup_workers", (PyCFunction)gc_get_cleanup_workers, METH_NOARGS, gc_get_cleanup_workers__doc__},

static PyObject *
gc_get_cleanup_workers_impl(PyObject *module);

static PyObject *
gc_get_cleanup_workers(PyObject *module, PyObject *Py_UNUSED(ignored))
{
