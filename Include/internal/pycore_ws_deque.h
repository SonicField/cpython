...
#include "pycore_gc_atomic_compat.h"        // _Py_atomic_* (3.12 compat wrappers)
...
//
// This implementation uses CPython's atomic abstractions
// (pycore_gc_atomic_compat.h) instead of raw C11 atomics for portability.
