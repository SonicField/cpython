...
#define HIR_TYPE_WAITHANDLE     HIR_TYPE_SIMPLE(0x00000000200ULL, HIR_TYPE_LIFETIME_TOP)
...
#define HIR_TYPE_TYPEEXACT      HIR_TYPE_SIMPLE(0x00000080000ULL, HIR_TYPE_LIFETIME_TOP)
#define HIR_TYPE_UNICODEEXACT   HIR_TYPE_SIMPLE(0x00000100000ULL, HIR_TYPE_LIFETIME_TOP)

/* Compound types */
#define HIR_TYPE_PRIMITIVE      HIR_TYPE_SIMPLE(0xfff00000000ULL, HIR_TYPE_LIFETIME_BOTTOM)
#define HIR_TYPE_TOP            HIR_TYPE_SIMPLE(0xfffffffffffULL, HIR_TYPE_LIFETIME_TOP)
#define HIR_TYPE_OPTUNICODE     HIR_TYPE_SIMPLE(0x80080100000ULL, HIR_TYPE_LIFETIME_TOP)

/* Precomputed union types for operand type table */
#define HIR_TYPE_OPTOBJECT_OR_CUINT64 \
    HIR_TYPE_SIMPLE(0x810ffffffffULL, HIR_TYPE_LIFETIME_TOP)
