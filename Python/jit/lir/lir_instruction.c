...
/* ---- InstrProperty table (C equivalent of InstrProperty::prop_map_) ---- */

typedef struct {
    uint8_t inputs_live_across;
    uint8_t output_phy_use;
    uint8_t num_input_phy_uses;
    uint8_t input_phy_uses[3];
    uint8_t is_essential;
} LirInstrProp;

/* Macro to populate the table from FOREACH_INSTR_TYPE.
 * X(name, live_across, flag_effects, opnd_size, output_use, {uses...}, essential)
 * We only need: live_across, output_use, input uses, essential.
 * Default values: live_across=0, output_use=1, uses={}, essential=0 */
#define PROP_0(n) {0, 1, 0, {0,0,0}, 0},
#define PROP_1(n, la) {la, 1, 0, {0,0,0}, 0},
#define PROP_2(n, la, fe) {la, 1, 0, {0,0,0}, 0},
#define PROP_3(n, la, fe, osz) {la, 1, 0, {0,0,0}, 0},
#define PROP_4(n, la, fe, osz, ou) {la, ou, 0, {0,0,0}, 0},

/* For the variadic input_phy_uses, we need specific overloads */
static const LirInstrProp s_instr_props[] = {
    /* Bind */     {0, 1, 0, {0,0,0}, 0},
    /* Nop */      {0, 1, 0, {0,0,0}, 0},
    /* Unreachable */ {0, 1, 0, {0,0,0}, 0},
    /* Call */      {0, 1, 0, {0,0,0}, 0},
    /* VectorCall */ {0, 1, 0, {0,0,0}, 0},
    /* VarArgCall */ {0, 1, 0, {0,0,0}, 0},
    /* Guard */    {0, 1, 0, {0,0,0}, 0},
    /* DeoptPatchpoint */ {0, 1, 0, {0,0,0}, 0},
    /* Sext */     {0, 1, 0, {0,0,0}, 0},
    /* Zext */     {0, 1, 0, {0,0,0}, 0},
    /* Negate */   {0, 1, 0, {0,0,0}, 0},
    /* Invert */   {0, 1, 0, {0,0,0}, 0},
    /* Add */      {0, 1, 1, {1,0,0}, 0},
    /* Sub */      {1, 1, 1, {1,0,0}, 0},
    /* And */      {0, 1, 1, {1,0,0}, 0},
    /* Xor */      {0, 1, 1, {1,0,0}, 0},
    ...
    /* Fmul */     {0, 1, 2, {1,1,0}, 0},
    /* Fdiv */     {1, 1, 2, {1,1,0}, 0},
    /* LShift */   {0, 1, 0, {0,0,0}, 0},
    /* RShift */   {0, 1, 0, {0,0,0}, 0},
    /* RShiftUn */ {0, 1, 0, {0,0,0}, 0},
    /* Test */     {0, 0, 2, {1,1,0}, 0},
    /* Test32 */   {0, 0, 2, {1,1,0}, 0},
    /* Equal */    {0, 1, 2, {1,1,0}, 0},
    /* NotEqual */ {0, 1, 2, {1,1,0}, 0},
    /* GreaterThanSigned */ {0, 1, 2, {1,1,0}, 0},
    /* LessThanSigned */    {0, 1, 2, {1,1,0}, 0},
    /* GreaterThanEqualSigned */ {0, 1, 2, {1,1,0}, 0},
    /* LessThanEqualSigned */    {0, 1, 2, {1,1,0}, 0},
    /* GreaterThanUnsigned */    {0, 1, 2, {1,1,0}, 0},
    /* LessThanUnsigned */       {0, 1, 2, {1,1,0}, 0},
    /* GreaterThanEqualUnsigned */ {0, 1, 2, {1,1,0}, 0},
    /* LessThanEqualUnsigned */    {0, 1, 2, {1,1,0}, 0},
    /* Cmp */      {0, 1, 2, {1,1,0}, 0},
    /* Lea */      {0, 1, 2, {1,1,0}, 0},
    /* LoadArg */  {0, 1, 0, {0,0,0}, 0},
    /* LoadSecondCallResult */ {0, 0, 0, {0,0,0}, 0},
    /* Exchange */ {0, 1, 2, {1,1,0}, 0},
    /* Move */     {0, 1, 0, {0,0,0}, 0},
    /* MoveRelaxed */ {0, 1, 0, {0,0,0}, 0},
    /* Push */     {0, 1, 0, {0,0,0}, 1},
    /* Pop */      {0, 0, 0, {0,0,0}, 1},
    /* Cdq */      {0, 1, 0, {0,0,0}, 1},
    /* Cwd */      {0, 1, 0, {0,0,0}, 1},
    /* Cqo */      {0, 1, 0, {0,0,0}, 1},
    /* Branch */   {0, 1, 0, {0,0,0}, 0},
    /* BranchNZ */ {0, 1, 0, {0,0,0}, 0},
    /* BranchZ */  {0, 1, 0, {0,0,0}, 0},
    /* BranchA */  {0, 1, 0, {0,0,0}, 0},
    /* BranchB */  {0, 1, 0, {0,0,0}, 0},
    /* BranchAE */ {0, 1, 0, {0,0,0}, 0},
    /* BranchBE */ {0, 1, 0, {0,0,0}, 0},
    /* BranchG */  {0, 1, 0, {0,0,0}, 0},
    /* BranchL */  {0, 1, 0, {0,0,0}, 0},
    /* BranchGE */ {0, 1, 0, {0,0,0}, 0},
    /* BranchLE */ {0, 1, 0, {0,0,0}, 0},
    /* BranchC */  {0, 1, 0, {0,0,0}, 0},
    /* BranchNC */ {0, 1, 0, {0,0,0}, 0},
    /* BranchO */  {0, 1, 0, {0,0,0}, 0},
    /* BranchNO */ {0, 1, 0, {0,0,0}, 0},
    /* BranchS */  {0, 1, 0, {0,0,0}, 0},
    /* BranchNS */ {0, 1, 0, {0,0,0}, 0},
    /* BranchE */  {0, 1, 0, {0,0,0}, 0},
    /* BranchNE */ {0, 1, 0, {0,0,0}, 0},
    /* BitTest */  {0, 1, 1, {1,0,0}, 0},
    /* Inc */      {0, 1, 0, {0,0,0}, 0},
    /* Dec */      {0, 1, 0, {0,0,0}, 0},
    /* CondBranch */ {0, 0, 1, {1,0,0}, 0},
    /* Select */   {1, 1, 3, {1,1,1}, 0},
    /* Phi */      {0, 1, 0, {0,0,0}, 0},
    /* Return */   {0, 1, 0, {0,0,0}, 0},
    /* MovZX */    {0, 1, 0, {0,0,0}, 0},
    /* MovSX */    {0, 1, 0, {0,0,0}, 0},
    /* MovSXD */   {0, 1, 0, {0,0,0}, 0},
    /* IntToBool */ {0, 1, 1, {1,0,0}, 0},
    /* YieldInitial */ {0, 0, 0, {0,0,0}, 1},
    /* YieldFrom */    {0, 0, 0, {0,0,0}, 1},
    /* YieldFromSkipInitialSend */ {0, 0, 0, {0,0,0}, 1},
    /* YieldFromHandleStopAsyncIteration */ {0, 0, 0, {0,0,0}, 1},
    /* YieldValue */ {0, 0, 0, {0,0,0}, 1},
};

#define NUM_LIR_INSTR_PROPS (sizeof(s_instr_props) / sizeof(s_instr_props[0]))

int
lir_instr_get_output_phy_reg_use(int opcode) {
    if (opcode < 0 || (size_t)opcode >= NUM_LIR_INSTR_PROPS) return 1;
    return s_instr_props[opcode].output_phy_use;
}

int
lir_instr_get_input_phy_reg_use(int opcode, size_t i) {
    if (opcode < 0 || (size_t)opcode >= NUM_LIR_INSTR_PROPS) return 0;
    const LirInstrProp *p = &s_instr_props[opcode];
    if (i >= p->num_input_phy_uses) return 0;
    return p->input_phy_uses[i];
}

int
lir_instr_inputs_live_across(int opcode) {
    if (opcode < 0 || (size_t)opcode >= NUM_LIR_INSTR_PROPS) return 0;
    return s_instr_props[opcode].inputs_live_across;
}
